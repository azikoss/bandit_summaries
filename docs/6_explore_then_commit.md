...
We let the ETC algorithm to play a Bernoulli bandit with <img src="https://render.githubusercontent.com/render/math?math=k=2"> arms and reward means <img src="https://render.githubusercontent.com/render/math?math=\mu_1=0.5"> and <img src="https://render.githubusercontent.com/render/math?math=\mu_2=\mu_1-\Delta"> where <img src="https://render.githubusercontent.com/render/math?math=\Delta"> is sampled from the interval of <img src="https://render.githubusercontent.com/render/math?math=[0, 0.5]">. The horizon was <img src="https://render.githubusercontent.com/render/math?math=n=5000">. The figure below shows the expected reward. Each point in the figure is a mean of 250 simulations. 
